...
import CreateFormSwitch from "../Components/Matching/CheckBox.js";
...
function createMessageModal(message, onClose, socket) {
    ...
    const modalTitle = createElement(
        "div",
        { class: "modal-title", id: "modal-title-content" },
...
class MatchingPage {
    ...
    toggleButtonContainer() {
        document
            .getElementById("match-btn-container")
    ...
    dispose() {
        ...
        if (this.waitModal) {
            ...
            if (
                ...
                typeof this.waitModal.modal.dispose === "function"
            ) {

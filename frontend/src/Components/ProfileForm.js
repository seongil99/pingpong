...
const ProfileForm = async () => {
  ...
  const openFileBtn = createElement(
    "button",
    {
      ...
      events: {
        click: () => {
          const fileInput = document.getElementById("edit-profile-img-input");
  ...
  const emailInfo = createElement("span", { class: "email-info" }, data?.email);
  ...
  const editBtn = createElement(
    "button",
    {
      ...
      events: {
        click: (event) => {
          document.querySelector(".username-input").classList.remove("hide");
          document.querySelector(".profile-save-btn").classList.remove("hide");
          document
  ...
  const saveBtn = createElement(
    "button",
    {
      ...
      events: {
        click: async (event) => {
          document.querySelector(".username-input").classList.add("hide");
          document.querySelector(".profile-cancel-btn").classList.add("hide");
          document.querySelector(".profile-edit-btn").classList.remove("hide");
  ...
  const cancelBtn = createElement(
    "button",
    {
      ...
      events: {
        click: (event) => {
          document.querySelector(".profile-save-btn").classList.add("hide");
          document.querySelector(".profile-edit-btn").classList.remove("hide");
          document.querySelector(".edit-bg").classList.add("hide");
          document.querySelector(".username-input").classList.add("hide");
          event.target.classList.add("hide");

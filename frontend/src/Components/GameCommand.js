...
const GameCommandInfo = () => {
    const container = createElement("div", { class: "keyboard-guide-container" });

    const keys = [
        { idLabel: "key_move_left_label", idContent: "key_move_left_key" },
        { idLabel: "key_move_right_label", idContent: "key_move_right_key" },
        { idLabel: "key_change_color_label", idContent: "key_change_color_key" },
        { idLabel: "key_toggle_music_label", idContent: "key_toggle_music_key" },
